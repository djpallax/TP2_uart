...
set_property PACKAGE_PIN T8 [get_ports {o_uart_led[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_uart_led[0]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {o_uart_led[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_uart_led[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {o_uart_led[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_uart_led[2]}]
...
set_property PACKAGE_PIN B13 [get_ports {i_uart_rx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_uart_rx}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {o_uart_tx}]					
